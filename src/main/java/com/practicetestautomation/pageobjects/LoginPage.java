...
public class LoginPage extends BasePage {
    ...
    public SuccessfulLoginPage executeLogin(String username, String password) {
        ...
        clickSubmitButton();
        return new SuccessfulLoginPage(driver); // This change makes our execute login method more powerful, allowing us to chain our actions naturally in the tests and directly interact with the successful login page.
    }

    public String getErrorMessage() { //this is a common operation so it can be used in the base page
