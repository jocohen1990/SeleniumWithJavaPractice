...
public class ExceptionsPage extends BasePage {
    private By addButtonLocator = By.id("add_btn"); //using private as we don't need to use it anywhere else
    ...
    public ExceptionsPage(WebDriver driver) { //this is a parameter or constructor
        super(driver);
    }
    ...
    public boolean isRowTwoDisplayedAfterWait() {
        return super.waitForIsDisplayed(row2InputField);
